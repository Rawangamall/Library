...
import Operations from './../Models/BorrowingModel';
...
class BorrowerController {
  ...
  static getAllBorrowers = CatchAsync(async (req, res, next) => {
  ...
  static updateBorrower = CatchAsync(async (req, res, next) => {
    const borrowerId = parseInt(req.params.id);
  ...
  static deleteBorrower = CatchAsync(async (req, res, next) => {
    const borrowerId = parseInt(req.params.id);
  ...
  static addWishBook = CatchAsync(async (req, res, next)=>{
  ...
  static removeWishBook = CatchAsync(async (req, res, next)=>{
    const bookId = req.params.id;
    const token = req.headers.authorization?.split(' ')[1];
